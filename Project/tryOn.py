...
def detectUpperBody(image):
    cascadePath = "C:\Users\MAYANK CHITTORA\Downloads\Myntra Virtual room\Myntra Virtual room\Project\data\haarcascade_upperbody.xml"
    result = image.copy()
...
def cvloop(run_event):
    ...
    while run_event.is_set(): 
        ...
        for face in faces: 
            ...
            if SPRITES[5]:
                findRects = []
                upperPath = "C:\Users\MAYANK CHITTORA\Downloads\Myntra Virtual room\Myntra Virtual room\Project\data\haarcascade_upperbody.xml"
